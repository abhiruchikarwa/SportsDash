                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <div className="card-body row scrollable justify-content-center">
                                    ...
                                    {
                                        this.state.favorites && this.state.favorites.teams
                                        && this.state.favorites.teams.map((team, index) =>
                                            <div key={index}
                                    ...
                                    {
                                        this.state.favorites && this.state.favorites.players
                                        && this.state.favorites.players.map((player, index) =>
                                            <div key={index}
                                                 className="card col-md-2 card-view-item shadow justify-content-center align-items-center">
                                                <div
